...
/**
 *
 * Copied from Ant utils.
 * Ref - http://svn.apache.org/repos/asf/ant/core/trunk/src/main/org/apache/tools/ant/util/UUEncoder.java
 *
...
public class CustomUUEncoder {
     ...
     */
    public CustomUUEncoder(String name) {
        this.name = name;
    }
